...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="contenedor-navbar">
            <nav class="navbar">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a id="clothes" href="controller_product?action=category&name=Clothes" class="boton-menu boton-categoria active">Clothes</a>
                    </li>
                    <li>
        ...
        <main style="padding-top: 180px">
            <h2 class="titulo-principal"  id="titulo-principal">Clothes</h2>
