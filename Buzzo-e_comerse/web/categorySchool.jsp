...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="contenedor-navbar">
            <nav class="navbar">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a  class="boton-menu boton-categoria" href="controller_product?action=allproducts" target="container">All the products</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a id="scholl" href="controller_product?action=category&name=School" class="boton-menu boton-categoria active">School accesories</a>
                    </li>
                </ul>
        ...
        <main style="padding-top: 180px">
            <h2 class="titulo-principal"  id="titulo-principal">School</h2>
