...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="contenedor-navbar">
            <nav class="navbar">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a id="books" href="controller_product?action=category&name=Books" class="boton-menu boton-categoria active">Books</a>
                    </li>
                    <li>
        ...
        <main style="padding-top: 180px">
            <h2 class="titulo-principal"  id="titulo-principal">Books</h2>
